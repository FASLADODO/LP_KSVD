...
% USAGE: [D,X,T,W]=localitypreservingKSVD(Y,Dinit,Q_train,Tinit,H_train,....
...
%
% PS: This function follows the LC-KSVD function written by Zhuolin Jiang.
% ========================================================================

function [D,X,T,W]=localitypreservingKSVD(Y,Dinit,Q_train,Tinit,H_train,Winit,iterations,sparsitythres,sqrt_alpha,sqrt_beta)
